            ...
            ->children()
                ...
                ->arrayNode('password_token')
                    ->children()
                        ...
                        ->arrayNode('serialization_groups')->info('PasswordToken serialization groups.')->defaultValue([])->useAttributeAsKey('name')->prototype('scalar')->end()
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('user')
                    ->children()
                        ...
                        ->arrayNode('authorized_fields')->defaultValue(['email'])->requiresAtLeastOneElement()->info('User fields names to retrieve it (email, username...).')->prototype('scalar')->end()
                        ->end()
