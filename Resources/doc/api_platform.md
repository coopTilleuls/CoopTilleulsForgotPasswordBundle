...
To add the routes to the API Platform Swagger documentation, you need to decorate the
`api_platform.swagger.normalizer.documentation` service, as following:
...
And the `DocumentationNormalizer` class should look like this:
